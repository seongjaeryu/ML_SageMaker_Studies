...
if __name__ == '__main__':
    ...
    # Model parameters
    parser.add_argument('--input_dim', type=int, default=2, metavar='INP_DIM',
                        help='number of input features (default: 2)')
    parser.add_argument('--hidden_dim', type=int, default=12, metavar='HID_DIM',
                        help='number of hidden layer dimenstions (default: 12)')
    parser.add_argument('--output_dim', type=int, default=1, metavar='OUT_DIM',
                        help='number of output results (default: 1)')
